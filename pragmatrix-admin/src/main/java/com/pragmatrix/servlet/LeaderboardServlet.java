...
/**
 * Leaderboard servlet.
 * GET /admin/leaderboard?quiz=BIZWIZX          → HTML leaderboard page
 * GET /admin/leaderboard?quiz=BIZWIZX&format=json → JSON for AJAX polling
 */
@WebServlet(name = "LeaderboardServlet", urlPatterns = {"/admin/leaderboard"})
