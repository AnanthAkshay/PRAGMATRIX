...
<body>
    ...
    <header class="site-header">
        <nav class="header-nav">
            ...
            <div class="header-links">
                ...
                <a href="${pageContext.request.contextPath}/team-login">Team Login</a>
                <a href="${pageContext.request.contextPath}/leaderboard?quiz=${selectedQuiz}" class="active">Leaderboard</a>
            </div>
        </nav>
    </header>
    ...
    <div class="page-container">
        ...
        <!-- Quiz Tabs -->
        <div class="quiz-tabs">
            <a href="${pageContext.request.contextPath}/leaderboard?quiz=BIZWIZX"
               class="quiz-tab <c:if test='${selectedQuiz == "BIZWIZX"}'>active</c:if>"
               id="lb-tab-bizwizx">BizWizX</a>
            <a href="${pageContext.request.contextPath}/leaderboard?quiz=VORTEX"
    ...
    (function() {
        ...
        var baseUrl = '${pageContext.request.contextPath}/leaderboard';
